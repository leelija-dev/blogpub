                ...
                <tr>
                    <td
                        ...
                        <p style="font-size:14px; margin:0 0 22px 0; color:#374151;">
                            Your order for the plan <strong>Premium Monthly</strong> has been successfully completed. Below are your activation details:
                        </p>
                        ...
                        <p style="font-size:14px; margin:22px 0 26px 0; color:#374151;">
                            Thank you for choosing <strong style="color:#4f46e5;">MyMailApp</strong>. You may now begin sending email campaigns instantly.
                        </p>
                ...
                <tr>
                    <td style="padding:28px 20px; color:#1f2937; line-height:1.6;">
                        ...
                        <p style="font-size:15px; margin:0 0 24px; color:#374151;">
                            Your order for the <strong>Premium Monthly</strong> plan has been completed successfully. Below are your plan details:
                        </p>
                        ...
                        <p style="font-size:15px; margin:26px 0 0; color:#374151;">
                            Thank you for choosing <strong style="color:#4f46e5;">MyMailApp</strong>. You can start creating and sending campaigns instantly.
                        </p>
                            ...
                            <tr>
                                <td style="padding:20px;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr><td style="padding:0 0 12px; font-size:15px; color:#111827;">John Doe<br><span style="color:#4f46e5;">john@example.com</span></td></tr>

                                        <tr><td style="padding:8px 0; font-size:13px; color:#6b7280;"><strong>Plan</strong></td></tr>
                                        <tr><td style="padding:0 0 12px; font-size:15px; color:#111827;">Premium Monthly</td></tr>

                                        <tr><td style="padding:8px 0; font-size:13px; color:#6b7280;"><strong>Amount</strong></td></tr>
                                        <tr><td style="padding:0 0 12px; font-size:15px; color:#16a34a; font-weight:bold;">₹1999 INR</td></tr>

                                        <tr><td style="padding:8px 0; font-size:13px; color:#6b7280;"><strong>Transaction ID</strong></td></tr>
                                        <tr><td style="padding:0 0 12px; font-size:15px; color:#111827; word-break:break-all;">txn_1P9xAbC123defGH456</td></tr>

                                        <tr><td style="padding:8px 0; font-size:13px; color:#6b7280;"><strong>Paid At</strong></td></tr>
                                        <tr><td style="padding:0; font-size:15px; color:#111827;">2025-03-12 14:28:45</td></tr>
                                    </table>
                                </td>
                            </tr>
                        </table>
